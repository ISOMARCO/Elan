        ...
        <div class="card">
            <div class="card-header">
                <span class="float-right">
                    <button data-toggle="modal" data-target="#create_category" class="btn btn-primary"><i class="fa-solid fa-plus"></i></button>&nbsp;
                    <button type="button" class="btn btn-secondary" id="searchButton"><i class="fa-solid fa-magnifying-glass"></i></button>
                </span>
            </div>
            <div class="card-body">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-1 col-sm-1">
                                <a href="javascript:void(0)"><i class="fa-solid fa-arrow-right fa-lg"></i></a>
                            </div>
