<footer class="footer-part">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="footer-content"><h3>Contact Us</h3>
                    <ul class="footer-address">
                        <li><i class="fas fa-map-marker-alt"></i>
                            <p>1420 West Jalkuri Fatullah, <span>Narayanganj, BD</span></p></li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="footer-info"><a href="#"><img src="{{asset('Assets/Frontend/images/logo.png')}}" alt="logo"></a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-card-content">
                    <div class="footer-payment"><a href="#"><img src="{{asset('Assets/Frontend/images/pay-card/01.jpg')}}" alt="01"></a><a
                            href="#"><img src="{{asset('Assets/Frontend/images/pay-card/02.jpg')}}" alt="02"></a><a href="#"><img
                                src="{{asset('Assets/Frontend/images/pay-card/03.jpg')}}" alt="03"></a><a href="#"><img src="{{asset('Assets/Frontend/images/pay-card/04.jpg')}}"
                                                                                           alt="04"></a></div>
                    <div class="footer-option">
                        <button type="button" data-toggle="modal" data-target="#language"><i class="fas fa-globe"></i>English
                        </button>
                        <button type="button" data-toggle="modal" data-target="#currency"><i
                                class="fas fa-dollar-sign"></i>USD
                        </button>
                    </div>
                    <div class="footer-app"><a href="#"><img src="{{asset('Assets/Frontend/images/play-store.png')}}" alt="play-store"></a><a
                            href="#"><img src="{{asset('Assets/Frontend/images/app-store.png')}}" alt="app-store"></a></div>
                </div>
            </div>
        </div>
    </div>
    <div class="footer-end">
        <div class="container">
            <div class="footer-end-content"><p>All Copyrights Reserved &copy; 2021 - Developed by <a
                        href="#">Mironcoder</a></p>
...
<div class="modal fade" id="currency">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header"><h4>Choose a Currency</h4>
...
<div class="modal fade" id="language">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header"><h4>Choose a Language</h4>
                <button class="fas fa-times" data-dismiss="modal"></button>
            </div>
            <div class="modal-body">
...
<script>
    ...
    .then(data => {
        ...
        channel.bind('my-event', function(data) {
            ...
            var audio = new Audio($("#notificationSound").attr("src"));
            audio.play();
        });
    });
</script>
