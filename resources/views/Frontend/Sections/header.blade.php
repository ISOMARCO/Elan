<header class="header-part">
    <div class="container">
        <audio id="notificationSound" src="{{asset('Assets/Frontend/sound/notification.mp3')}}" preload="auto"></audio>
            ...
            <div class="sidebar-menu">
                ...
                <div class="tab-pane" id="author-menu">
                    <ul class="navbar-list">
                        ...
                        @if(Session::has('admin'))
                            <li class="navbar-item"><a class="navbar-link" target="_blank" href="{{route('Backend.Home')}}">Admin Panel</a></li>
                        @endif
                        ...
                        <li class="navbar-item"><a class="navbar-link" id="logout_url" href="javascript:void(0)">Logout</a></li>
                    </ul>
                </div>
            </div>
